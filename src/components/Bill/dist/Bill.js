...
var Bill = function (_a) {
    ...
    return (React.createElement("div", { className: "container mx-auto px-40 mt-10" },
        React.createElement("h2", { className: "font-semibold mb-2" }, "BILLING ADDRESS"),
        React.createElement("hr", { className: "mb-4" }),
        React.createElement("form", { onSubmit: handleSubmit },
            React.createElement("label", { className: "text-sm" }, "First Name *"),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: firstName, onChange: handleFirstNameChange, required: true }),
            ...
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: lastName, onChange: handleLastNameChange, required: true }),
            lastNameError && React.createElement("div", { className: "text-red-500" }, lastNameError),
            React.createElement("label", { className: "text-sm" }, "Company Name "),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: companyName, onChange: handleCompanyNameChange }),
            React.createElement("label", { className: "text-sm" }, "Country / Region *"),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: country, onChange: handleCountryChange, required: true }),
            ...
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-2 ", placeholder: "House number and street name", value: streetAddress, onChange: handleStreetAddressChange, required: true }),
            streetAddressError && (React.createElement("div", { className: "text-red-500" }, streetAddressError)),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4 ", placeholder: "Apartment, suite, unite, etc. (optional)", value: apartment, onChange: function (e) { return setApartment(e.target.value); } }),
            React.createElement("label", { className: "text-sm" }, "Town / City *"),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: townCity, onChange: handleTownCityChange, required: true }),
            ...
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: state, onChange: handleStateChange, required: true }),
            stateError && React.createElement("div", { className: "text-red-500" }, stateError),
            React.createElement("label", { className: "text-sm" }, "Zip Code *"),
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: zipCode, onChange: handleZipCodeChange, required: true }),
            ...
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: phone, placeholder: "703409876", onChange: handlePhoneChange, required: true }),
            ...
            React.createElement("input", { type: "text", className: "w-full px-4 h-10 bg-gray-100 rounded-md mt-2 mb-4", value: email, onChange: handleEmailChange, required: true }),
