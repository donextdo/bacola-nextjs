    ...
    return (React.createElement("div", { className: "flex flex-row mb-9" },
        ...
        React.createElement("div", { className: "lg:w-3/4 md:w-full w-full mt-12 md:ml-9" },
            ...
            React.createElement("div", { className: "lg:mt-12 md:mt-12 mt-12 cursor-pointer" },
                React.createElement(FilteredProduct_1.FilteredProduct, { categoryId: categoryId, brand: brand, subcategory: subcategory, minValue: minValue, maxValue: maxValue, inStock: inStock, onSale: onSale, perpage: perpage, page: page, orderby: orderby })),
            React.createElement("div", null,
