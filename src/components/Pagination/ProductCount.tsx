  ...
  return (
    <div className="w-full h-14 bg-gray-100 mt-11 relative">
      <div className="flex flex-row items-center  justify-between py-2">
        <div>
          <button
            className="lg:hidden ml-3 flex items gap-2"
            onClick={handleFilterSiderbar}
          >
          ...
          <div className="hidden lg:block">
            <div className="flex flex-row items-center ml-3 ">
              <div className="flex mx-2">
                <BsList
                  className={`text-2xl stroke-[2] ${
                    isClick === "list" ? "text-black" : "text-gray-300"
              ...
              <div className="flex mx-2">
                <BsFillGridFill
                  className={`text-xl ${
                    isClick === "fillGrid" ? "text-black" : "text-gray-300"
                  } cursor-pointer hover:text-black`}
              ...
              <div className="flex mx-2">
                <BsGrid3X3GapFill
                  className={`text-xl ${
                    isClick === "grid3X3Gap" ? "text-black" : "text-gray-300"
                  } cursor-pointer hover:text-black`}
              ...
              <div className="flex mx-2">
                <TfiLayoutGrid4Alt
                  className={`text-xl ${
                    isClick === "layoutGrid" ? "text-black" : "text-gray-300"
                  } cursor-pointer hover:text-black`}
        ...
        <div>
          <div className="lg:hidden mr-3 flex items-center py-3 gap-2">
            <div className="text-xs text-[#9b9bb4]">{sortBy}</div>
            <div className="text-xl">
              <BiSortAlt2
                className="mx-2 text-xl text-black cursor-pointer"
          ...
          <div className="hidden lg:block">
            <div className="flex items-center py-3 mr-4  ">
              ...
              <span className="text-xs text-black font-medium pl-2">
                {count}
              </span>
              <div>
                <MdKeyboardArrowDown
          ...
          {/* </div> */}
          {showSortMenu && (
            <div className="font-semibold absolute top-9 lg:right-16 md:right-16 right-11 bg-white border border-gray-300 rounded-md shadow-md z-10 w-56  ">
              <div
