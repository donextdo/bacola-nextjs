...
var Image_1 = require("../FilterSideBar/Image");
...
var ProductPagination_1 = require("./ProductPagination");
var react_1 = require("react");
var RecentlyViewProduct_1 = require("../RecentlyViewProduct/RecentlyViewProduct");
exports.HomePagination = function (_a) {
    var perpage = _a.perpage, page = _a.page, orderby = _a.orderby, brand = _a.brand, minValue = _a.minValue, maxValue = _a.maxValue, inStock = _a.inStock, onSale = _a.onSale;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flex flex-row mb-9" },
            React.createElement("div", { className: "lg:w-1/4 hidden lg:block" },
                React.createElement("div", { className: "grid md:grid-cols-1 grid-cols-1 " },
                    React.createElement(RangeSlider_1.RangeSlider, null),
            ...
            React.createElement("div", { className: "lg:w-3/4 md:w-full w-full mt-12 md:ml-9" },
                ...
                React.createElement("div", { className: "mt-10" },
                    React.createElement(ProductPagination_1.ProductPagination, { brand: brand, minValue: minValue, maxValue: maxValue, inStock: inStock, onSale: onSale, passgrid: passgrid, perpage: perpage, page: page, orderby: orderby })),
        ...
        React.createElement("div", { className: "pb-20 pt-20" },
            React.createElement(RecentlyViewProduct_1.RecentlyViewProduct, { passgrid: passgrid }))));
};
