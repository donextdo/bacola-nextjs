...
exports.HomePagination = function (_a) {
    var perpage = _a.perpage, page = _a.page, orderby = _a.orderby;
    ...
    return (React.createElement("div", { className: "flex flex-row mb-9" },
        ...
        React.createElement("div", { className: "lg:w-3/4 md:w-full w-full mt-12 md:ml-9" },
            ...
            React.createElement("div", null,
                React.createElement(ProductCount_1.ProductCount, null)),
            React.createElement("div", { className: "mt-10" },
                React.createElement(ProductPagination_1.ProductPagination, { perpage: perpage, page: page, orderby: orderby })),
