...
exports.RangeSlider = function (_a) {
    ...
    var _c = react_1.useState(50), maxValue = _c[0], setMaxValue = _c[1];
    ...
    return (React.createElement("div", { className: "box-border max-h-[85px] max-w-[270px] lg:mt-12  " },
        React.createElement("h4", { className: "max-h-[18px] max-w-[270px] uppercase tracking-[0] font-[600] text-[.9375rem] mb-[1.25rem] font-ff-headings" }, "filter by price"),
        React.createElement("div", { className: "mb-4 max-h-[47px] max-w-[270px]" },
            ...
            React.createElement("div", { className: "range-input relative" },
                React.createElement("input", { onChange: handleMin, type: "range", value: minValue, min: 0, step: 10, max: 50, className: "range-min absolute\r\n             w-full -top-1 h-1 bg-transparent appearance-none pointer-events-none ", placeholder: "Select a minimum value" }),
                React.createElement("input", { onChange: handleMax, type: "range", value: maxValue, min: 0, step: 10, max: 50, className: "range-max absolute\r\n             w-full -top-1 h-1 bg-transparent appearance-none pointer-events-none", placeholder: "Select a maximum value" }))),
        React.createElement("div", { className: "max-h-[47px] max-w[270px]" },
            React.createElement("div", { className: "max-h-[18px] max-w[270px] grid gap-0 grid-cols-2 " },
