...
exports.SearchItem = function () {
    ...
    //   // }
    // }, [searchItem]);
    return (react_1["default"].createElement("div", { className: " flex flex-col min-h-[60px] min-w-[557.51px] place-content-center" },
        ...
        react_1["default"].createElement("div", { className: "bg-white flex flex-col border-solid border-2 border-gray-200 " },
            react_1["default"].createElement("ul", null, products
                ...
                react_1["default"].createElement("div", { className: "flex flex-col" },
                    react_1["default"].createElement("li", { key: item.id, className: "cursor-pointer text-end text-gray-400 font-semibold line-through mr-2 text-[14px]" }, item.price),
                    react_1["default"].createElement("li", { key: item.id, className: "cursor-pointer text-end text-red-700 text-lg font-semibold mr-2" }, item.price)))); })))));
};
