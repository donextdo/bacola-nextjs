                ...
                <div className="w-full h-full pb-10">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-12 gap-2 border-b border-[#e4e5ee] pb-3">
                            ...
                            <div className="text-xs text-[#71778e] font-semibold sm:col-span-3">Quantity</div>
                            <div className="text-xs text-[#71778e] font-semibold hidden sm:block">Subtotal</div>
                            <div></div>
                        </div>

                        {/* products */}
                        <div className="grid grid-cols-4 sm:grid-cols-12 grid-2 border-b border-[#e4e5ee] py-3 h-28 items-center relative">
                            ...
                            <div className="col-span-2 hidden sm:block">$27.49</div>
